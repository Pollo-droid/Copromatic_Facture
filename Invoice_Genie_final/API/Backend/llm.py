            ...
            functions=[
                {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "nom_de_l'entreprise": {"type": "string", "description": "The name of the company issuing the invoice"},
                            "numero_de_facture": {"type": "string", "description": "The unique identifier for the invoice. Usually called N°facture. It can contain letters"},
                            "date": {"type": "string", "description": "The date of the invoice (ISO 8601 format preferred)"},
                            "date_échéance": {"type": "string", "description": "The due date for payment (ISO 8601 format preferred)"},
                            "montant_total": {"type": "number", "description": "The total amount due on the invoice"},
                            "montant net": {"type": "number", "description": "The net amount due on the invoice"},
                            "montant_taxe": {"type": "number", "description": "The tax amount due on the invoice"},
                            "devise": {"type": "string", "description": "The currency used in the invoice (e.g., USD, EUR)"},
                            "adresse_facturation": {"type": "string", "description": "The billing address on the invoice"},
                            "copropriete": {"type": "string", "description": "The name of the condominium association, known in french as syndicat de copropriété, SDC or copropriété for short. Sometimes this name comes after the word REF"},
                            "numero_de_contrat": {"type": "number", "description": "The contract number on the invoice called N°contrat"},
                            "numero_SIRET": {"type": "number", "description": "A unique identification number assigned to businesses and establishments in France (e.g.,123 456 789 00012)"},
                            "référence_acheminement": {"type": "number", "description": "A unique identification number assigned to associated with the shipment or delivery of a package or parcel (e.g. Référence acheminement : 19592619309415)"},
                            "line_items": {
                                "type": "array",
                                "items": {
                                    "type": "object",
